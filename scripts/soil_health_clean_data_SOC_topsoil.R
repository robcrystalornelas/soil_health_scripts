...
raw_data_SOC_with_nas_topsoil$control_sd_standardized_SOC_ten <- imputed_sds_SOC_topsoil$control_sd_standardized_SOC_ten
raw_data_SOC_with_nas_topsoil$treatment_sd_standardized_SOC_ten <- imputed_sds_SOC_topsoil$treatment_sd_standardized_SOC_ten
