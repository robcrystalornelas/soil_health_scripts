...
## read in data ####
soil_health_raw_data_combined_MBC <- read.csv("~/Desktop/research/UMD_org_soil_MA/Crystal-Ornelas_Thapa_Tully_datasheet - datasheet_combined_soil_depth_MBC.csv", header = TRUE)
dim(soil_health_raw_data_combined_MBC)

# Get just the columns we need
raw_data_MBC_with_nas_combined <- dplyr::select(soil_health_raw_data_combined_MBC, study_code,weighted_control_mean_standardized, weighted_control_sd_standardized, control_n,weighted_treatment_mean_standardized,weighted_treatment_sd_standardized,treatment_n)
