...
raw_data_SOC_with_nas_combined <- dplyr::select(raw_data_SOC_combined, study_code,control_mean_standardized, control_sd_standardized, control_n,treatment_mean_standardized,treatment_sd_standardized,treatment_n)
raw_data_MBC_with_nas_combined <- dplyr::select(raw_data_MBC_combined, study_code,control_mean_standardized, control_sd_standardized, control_n,treatment_mean_standardized,treatment_sd_standardized,treatment_n)
...
raw_data_SOC_combined$control_sd_standardized <- imputed_sds_SOC_combined$control_sd_standardized
raw_data_SOC_combined$treatment_sd_standardized <- imputed_sds_SOC_combined$treatment_sd_standardized
raw_d
...
# Now that we have imputed values, replace whole column in R
raw_data_MBC_combined$control_sd_standardized <- imputed_sds_MBC_combined$control_sd_standardized
raw_data_MBC_combined$treatment_sd_standardized <- imputed_sds_MBC_combined$treatment_sd_standardized
