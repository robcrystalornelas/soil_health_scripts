...
## import data
source(
  "~/Desktop/research/UMD_org_soil_MA/UMD_project/scripts/soil_health_clean_data_topsoil.R"
)
...
effect_sizes_SOC_topsoil <-
  escalc(
    ...
    m1i = raw_data_SOC_topsoil$treatment_mean_standardized, # provide means for group 1
    n1i = raw_data_SOC_topsoil$treatment_n, # treatment sample size
    sd1i = raw_data_SOC_topsoil$treatment_sd_standardized, # treatment SD
    m2i = raw_data_SOC_topsoil$control_mean_standardized, # control mean
    n2i = raw_data_SOC_topsoil$control_n, # control sample size
    sd2i = raw_data_SOC_topsoil$control_sd_standardized, # control SD
